...
namespace DestekApp.Migrations
{
    public partial class bir : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Adresler",
                columns: new[] { "AdresID", "AdresBilgisi", "KullanıcıID" },
                values: new object[,]
                {
                    { 1, "Menekşe Mah. Petek Sk. No:31 Kat:3 Daire:6", 12 },
                    { 2, "Küpçüler Mah. Sema Sk. No:28 Kat:2 Daire:2", 17 },
                    { 3, "Eskiler Cad. Fırın Sk. No:38 Pendik", 17 },
                    { 4, "Çakmak Cad. Turgut Özal Sk. No:16 Kat:1 Daire:13", 16 },
                    { 5, "Yedi İklim Mah. Güngören Cad. Lacivert Sk. No:45 Kat:3 Daire:7", 57 }
                });
            ...
            migrationBuilder.InsertData(
                table: "İletişimler",
                columns: new[] { "İletişimID", "KullanıcıID", "TelefonNo" },
                values: new object[,]
                {
                    { 1, 12, "05303303030" },
                    { 2, 17, "05313313131" },
